        ...
        <div className="relative mx-auto mb-4 flex h-32 w-32 items-center justify-center">
          <svg className="absolute inset-0 -rotate-90" viewBox="0 0 100 100">
            ...
            <motion.circle
              ...
              animate={{ strokeDashoffset: 2 * Math.PI * 42 * (1 - 0.842) }}
              transition={{ duration: 2, ease: "easeOut" }}
            />
          </svg>
          <div className="text-center">
            <span className="text-3xl font-bold text-primary" style={{ fontFamily: "'JetBrains Mono', monospace" }}>84.2</span>
          ...
          {HEALTH_METRICS.map((m, i) => (
            <motion.div key={m.label} variants={staggerItem} className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-medium" style={{ fontFamily: "'JetBrains Mono', monospace", color: m.color }}>{m.score}</span>
              </div>
